...
void AppMainView::CreateBody() const
{
    ...
    static auto MainStack = luGUI::Stack::Create(luGUI::Orientation::Vertical, Alignment, MaxWidth);
    ...
    if (MainStack->IsEmpty())
    {
        ...
        MainStack->Add(luGUI::Grid::Create()
                 ...
                 ->Add(luGUI::Stack::Create(luGUI::Orientation::Vertical)
        ...
        {
            MainStack->Add(CreateWin32ParentingStack(ParentWindow));
        }
        #endif
    }
